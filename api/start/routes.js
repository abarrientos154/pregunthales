...
addPrefixToGroup(
  Route.group(() => {
    ...
    Route.get('getExamWithQuestById/:id', 'ExamenController.getExamWithQuestById')
    ...
    Route.post('examen_user', 'ExamenController.storeExamen')
    Route.put('examen_user/:id', 'ExamenController.updateExamen')
