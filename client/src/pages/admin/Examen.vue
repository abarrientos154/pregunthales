...
export default {
  ...
  methods: {
    ...
    verifyCantidad () {
      let faltantes = 0
      if (this.edit) {
        faltantes = this.examen.faltantes + this.form.cantidad
      } else {
        faltantes = this.examen.faltantes
      }
      if ((this.form.cantidad > faltantes) || (this.nivelSelec && (this.form.cantidad > this.nivelSelec.total_question))) {
    ...
    questEdit (data) {
      ...
      this.niveles = data.course.tests
